        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-5">
            ...
            <a
              href={resumeUrl}
              download
              className="w-full sm:w-auto inline-flex items-center justify-center space-x-2 px-7 py-3.5 rounded-xl border border-[#26211B] hover:border-[#D4AF37]/60 bg-[#0A0908] text-[#F5F2EB] hover:text-white text-xs font-medium font-mono tracking-[0.18em] uppercase transition-all duration-300 cursor-pointer"
            >
