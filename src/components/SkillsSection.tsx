...
export const SkillsSection: React.FC = () => {
  ...
  const activeSkill = selectedSkill || allSkills[0] || {
    ...
    category: 'core',
    status: 'PRODUCTION',
    description: 'Core programming language for backend architecture, data pipelines, and AI systems.',
    relatedProjects: [],
  };
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 left-10 w-[30rem] h-[30rem] bg-[#D4AF37]/5 rounded-full blur-[160px] pointer-events-none" />
      ...
      <div className="max-w-[1760px] mx-auto w-full relative z-10">
        ...
        {/* Two-Column Grid: Inspector + Bento Grid */}
              ...
              >
                ...
                <div className="pt-3.5 border-t border-[#26211B]">
                  ...
                  {activeSkill.relatedProjects && activeSkill.relatedProjects.length > 0 ? (
                    ...
                    <p className="text-[11px] text-[#A8988B] italic font-sans">
