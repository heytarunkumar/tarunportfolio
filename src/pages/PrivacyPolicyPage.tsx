...
export const PrivacyPolicyPage: React.FC = () => {
  useEffect(() => {
    document.title = 'Privacy Policy & DPDP Act Compliance | Tarun Kumar (@heytarunkumar)';
    window.scrollTo(0, 0);
  }, []);
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-12 text-sm sm:text-base leading-relaxed text-[#38342E]">
          ...
          <section className="space-y-4">
            ...
            <p>
              This Privacy Policy governs the processing of personal data across the portfolio website and digital presence of <strong>Tarun Kumar</strong> (operating online as <code>@heytarunkumar</code>, reachable at <a href={SITE_CONFIG.url} className="text-[#78000F] underline">{SITE_CONFIG.url}</a>) and affiliated initiatives including the <strong>OrigoHOST Tech Community</strong> (<a href="https://origohost.in" target="_blank" rel="noopener noreferrer" className="text-[#78000F] underline">origohost.in</a>).
            </p>
            <p>
              Under the <strong>Digital Personal Data Protection Act, 2023 (India)</strong> ("DPDP Act") and applicable international frameworks (such as the General Data Protection Regulation - GDPR), <strong>Tarun Kumar</strong> acts as the <em>Data Fiduciary</em> (or Data Controller) regarding personal data collected through this website.
            </p>
            
            <div className="p-4 sm:p-5 rounded-[4px] bg-[#FAF8F3] border border-[#CFC3B3] font-mono text-xs space-y-1.5">
              <div className="text-[#78000F] font-bold uppercase tracking-wider mb-2">// DATA FIDUCIARY IDENTIFICATION</div>
              <div><strong className="text-[#111111]">Fiduciary Name:</strong> Tarun Kumar</div>
              <div><strong className="text-[#111111]">Affiliated Entity:</strong> OrigoHOST Tech Community (Founder &amp; President)</div>
              <div><strong className="text-[#111111]">Jurisdiction:</strong> Delhi NCR / Uttar Pradesh, India</div>
              <div><strong className="text-[#111111]">Direct Privacy Desk:</strong> <a href="mailto:tarunsinghchaudharyy@gmail.com" className="text-[#78000F] underline">tarunsinghchaudharyy@gmail.com</a></div>
            </div>
          </section>
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-3 pt-2">
              <div className="p-4 rounded-[4px] bg-[#FAF8F3] border border-[#CFC3B3]">
                <h3 className="font-serif font-bold text-[#111111] text-base mb-1">A. Direct Inquiries &amp; Communications</h3>
                <p className="text-xs sm:text-sm text-[#555047] mb-2">
                  When you submit a message via the portfolio contact form or send direct correspondence:
                </p>
                <ul className="list-disc list-inside text-xs sm:text-sm space-y-1 text-[#38342E]">
                  <li><strong>Full Name:</strong> To address you properly in correspondence.</li>
                  <li><strong>Email Address:</strong> To deliver direct responses to your inquiry.</li>
                  <li><strong>Subject &amp; Inquiry Message:</strong> To understand and review your technical, consulting, or community request.</li>
                </ul>
              </div>

              <div className="p-4 rounded-[4px] bg-[#FAF8F3] border border-[#CFC3B3]">
                <h3 className="font-serif font-bold text-[#111111] text-base mb-1">B. Technical Logs &amp; Security Telemetry</h3>
                <p className="text-xs sm:text-sm text-[#555047] mb-2">
              ...
              <div className="p-4 rounded-[4px] bg-[#FAF8F3] border border-[#CFC3B3]">
                <h3 className="font-serif font-bold text-[#111111] text-base mb-1">C. Client-Side Preferences (Local Storage Only)</h3>
                <p className="text-xs sm:text-sm text-[#555047]">
                  Theme preferences (<code>dark</code> / <code>light</code>) and Cookie Consent selections are saved locally on your browser via HTML5 Local Storage. This data never leaves your device and is not synchronized with any external server.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc list-inside space-y-2 text-xs sm:text-sm pl-2">
              <li><strong>Responding to Communications (Consent):</strong> Processing your contact message, project consultation request, or mentorship inquiry upon explicit consent provided when submitting the form.</li>
              <li><strong>Systems Reliability &amp; Defense (Legitimate Interest):</strong> Protecting server infrastructure against malicious traffic, bot spam, brute force attacks, or service abuse.</li>
              <li><strong>Community Engagement:</strong> Facilitating OrigoHOST Tech Community communications, research collaborations, or speaking invitations where requested by you.</li>
            </ul>
          </section>
          ...
          <section className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs font-mono pt-2">
              <div className="p-3.5 rounded-[3px] bg-[#FAF8F3] border border-[#CFC3B3]">
                <strong className="text-[#78000F] block mb-1">Vercel Inc. (Hosting &amp; Edge Delivery)</strong>
                Serves web application assets and enforces SSL/TLS encryption. Compliant with ISO 27001 and SOC 2 Type II.
              </div>
              <div className="p-3.5 rounded-[3px] bg-[#FAF8F3] border border-[#CFC3B3]">
                <strong className="text-[#78000F] block mb-1">FormSubmit / Direct SMTP Gateway</strong>
                Securely transports contact form submissions to the executive inbox via end-to-end TLS encryption.
              </div>
              <div className="p-3.5 rounded-[3px] bg-[#FAF8F3] border border-[#CFC3B3]">
                <strong className="text-[#78000F] block mb-1">Google Fonts &amp; GitHub Embeds</strong>
                Typography assets served with preconnect optimization. External links open with <code>rel="noopener noreferrer"</code>.
              </div>
              <div className="p-3.5 rounded-[3px] bg-[#FAF8F3] border border-[#CFC3B3]">
                <strong className="text-[#78000F] block mb-1">OrigoHOST Community Infrastructure</strong>
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc list-inside space-y-1.5 text-xs sm:text-sm pl-2">
              <li><strong>Data Retention:</strong> Inquiries submitted through the contact form are retained only for the duration required to address the matter or fulfill active professional engagements, after which they are securely archived or deleted.</li>
              <li><strong>Encryption in Transit:</strong> All HTTP traffic is strictly enforced over HTTPS with TLS 1.3 encryption and HSTS headers.</li>
              <li><strong>Access Controls:</strong> Administrative consoles and communication channels are guarded by multi-factor authentication (MFA) and cryptographic credentials.</li>
            </ul>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p>
              Under Chapter III of the <strong>DPDP Act, 2023</strong> and Article 15–22 of the GDPR, you possess irrevocable rights regarding your personal data:
            </p>
            
            <div className="space-y-3 pt-2">
              <div className="p-3.5 rounded-[3px] bg-[#FAF8F3] border border-[#CFC3B3] text-xs">
                <strong className="text-[#111111] font-serif text-sm block mb-1">1. Right to Access Summary of Personal Data (DPDP Act § 11)</strong>
              ...
              <div className="p-3.5 rounded-[3px] bg-[#FAF8F3] border border-[#CFC3B3] text-xs">
                <strong className="text-[#111111] font-serif text-sm block mb-1">2. Right to Correction &amp; Erasure (DPDP Act § 12)</strong>
              ...
              <div className="p-3.5 rounded-[3px] bg-[#FAF8F3] border border-[#CFC3B3] text-xs">
                <strong className="text-[#111111] font-serif text-sm block mb-1">3. Right of Grievance Redressal (DPDP Act § 13)</strong>
              ...
              <div className="p-3.5 rounded-[3px] bg-[#FAF8F3] border border-[#CFC3B3] text-xs">
                <strong className="text-[#111111] font-serif text-sm block mb-1">4. Right to Withdraw Consent &amp; Right to Nominate (DPDP Act § 6(4) &amp; § 14)</strong>
          ...
          <section className="space-y-4">
            ...
            <div className="p-5 rounded-[4px] bg-[#FAF8F3] border border-[#CFC3B3] font-mono text-xs space-y-2">
              <div className="text-[#78000F] font-bold uppercase tracking-wider mb-2">// STATUTORY GRIEVANCE DESK</div>
              <div><strong className="text-[#111111]">Designated Grievance Officer:</strong> Tarun Kumar</div>
              <div><strong className="text-[#111111]">Official Inquiries Email:</strong> <a href="mailto:tarunsinghchaudharyy@gmail.com" className="text-[#78000F] underline">tarunsinghchaudharyy@gmail.com</a></div>
              <div><strong className="text-[#111111]">Response SLA:</strong> Inquiries are acknowledged within 48 hours and resolved within statutory guidelines (under 30 days).</div>
              <div><strong className="text-[#111111]">Appellate Authority:</strong> If dissatisfied with our resolution, data principals in India have the right to appeal to the <em>Data Protection Board of India</em>.</div>
            </div>
          </section>
