...
export const AboutPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-black text-[#E8DFD8] pt-28 pb-16">
      <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-16 mb-12">
        <motion.div
        ...
        >
          ...
          >
            A dedicated Python backend software engineer actively expanding into cloud systems engineering, DevOps automation, container orchestration, and explainable machine learning architectures.
          </p>
        </motion.div>
      </div>
