    ...
    <div className="min-h-screen bg-black text-[#E8DFD8] pt-28 pb-16">
      <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-16 mb-8">
        ...
        >
          ...
          >
            Peer-collaborated academic research focused on Explainable AI (XAI) for medical tabular risk forecasting, feature attribution modeling with SHAP values, and interpretable clinical decision support systems.
          </p>
        </motion.div>
      </div>
